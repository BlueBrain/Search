...
from our_bert_classifier import OurBertClassifier
    ...
    def __post_init__(self):
        if self.dataset_name is None and self.train_file is None and self.validation_file is None:
            ...
            if self.train_file is not None:
                ...
                assert extension in ["pkl"], "`train_file` should be pickled dataframe."
            if self.validation_file is not None:
                extension = self.validation_file.split(".")[-1]
                assert extension in ["pkl"], "`validation_file` should be a pickled dataframe."
...
def main():
    ...
    if data_args.dataset_name is not None:
        ...
        datasets = load_dataset("pandas", data_files=data_files)
    ...
    #model = OurBertClassifier(model_args.model_name_or_path, config=config)
